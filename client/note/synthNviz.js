...
//       socket.emit('sounds', {'sound': {'type': 'synth', 'freq' : freq }});
...
//   var proc = synthContext.createScriptProcessor(1024, 1, 1); //synthContext.createBufferSource() //
//   // var proc.buffer = synthContext.createBuffer(1, 1024, synthContext.sampleRate);
